	...
	async created() {
        ...
        methods: {
            ...
            async startDelivery() {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['startdelivery'].href))
            ...
            async confirmDelivery() {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['confirmdelivery'].href))
                        for(var k in temp.data) {
                            this.value[k]=temp.data[k];
                        }
                    }
