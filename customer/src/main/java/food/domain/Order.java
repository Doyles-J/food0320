...
public class Order {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updateStatus(CoodStarted coodStarted) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(coodStarted.get???()).ifPresent(order->{
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updateStatus(CoodFinished coodFinished) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(coodFinished.get???()).ifPresent(order->{
